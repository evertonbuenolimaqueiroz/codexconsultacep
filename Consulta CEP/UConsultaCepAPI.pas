...
type
  ...
  public
    ...
    function ConsultarCEPHorse(const ACEP: string): Boolean;
  end;

implementation

function TConsultaCepAPI.ConsultarCEPHorse(const ACEP: string): Boolean;
var
    ...
    try
      ...
      begin
        ...
        JSONResponse := TJSONObject.ParseJSONValue
          (HttpResponse.ContentAsString(TEncoding.UTF8)) as TJSONObject;
        try
